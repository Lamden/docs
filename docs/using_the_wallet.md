...
Now you are able to sendthe copied address funds from your accounts, or you share the Address with somebody and ask them to send funds in the future.
...
Currency contract allows the processing of cryptocurrency transfersbetween accounts.
 
That smart-contract checks the balance on your account, and ifenough funds are available, the set amount will be sent to the recipient.
...
You are able tosave a backup of either your main account or all of your accounts stored in the wallet. 
