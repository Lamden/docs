...
# Submit Transactions to the Lamden Vault
...
- Transactions are locked to the name of the contract that was approved during the connection request.
    - One exception to this rule is <u>[TAU Approval](/wallet_api/approval_transactions)</u> transactions. Which ALWAYS prompt for a popup.
